...
object TransferObligation {
    ...
    class Initiator(private val linearId: UniqueIdentifier,
        ...
        override fun call(): SignedTransaction {
            ...
            val stx = subFlow(CollectSignaturesFlow(
                    ptx, sessions, listOf(inputObligation.lender.owningKey), Companion.COLLECT_SIGS.childProgressTracker()))
            ...
            return subFlow(FinalityFlow(stx, Companion.FINALISE.childProgressTracker()))
        }
    ...
    @InitiatedBy(TransferObligation.Initiator::class)
