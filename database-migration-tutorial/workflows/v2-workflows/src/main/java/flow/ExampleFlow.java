...
public class ExampleFlow {
    ...
    public static class Initiator extends FlowLogic<SignedTransaction> {
        ...
        public Initiator(int iouValue, Party otherParty, int newValue) {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            IOUState iouState = new IOUState(iouValue, me, otherParty, new UniqueIdentifier(), newValue);
