...
fun main(args: Array<String>) {
    UpgradeContractClientWithLegacyConstraint().main(args)
}
 ...
 *  themselves.
 **/
private class UpgradeContractClientWithLegacyConstraint {
    companion object {
        val logger: Logger = loggerFor<UpgradeContractClientWithLegacyConstraint>()
    }
