...
class ResponseParser {
    ...
    companion object {
         ...
         * provided from.
         */
        fun extractGitHubUsername(userNamePath: String, msg: String): String? {
            var username: String? = null
            try {
                val pathMatcher = object : PathMatcher {
                    override fun pathMatches(path: String) = Pattern.matches(userNamePath, path)
                ...
                logger.error("The request body does not contain a username at the specified path: $userNamePath.")
                return null
            }
            return username
        }
        ...
        fun verifyCreateKey(msg: String): Boolean {
            try {
                ...
                logger.error("Invalid pr comment. Please comment 'createKey'.")
                return false
            }
            return true
        }
