...
object IdentitySyncFlowWrapper {
    ...
    class Initiator(val otherParty: Party,
        ...
        override fun call(): Boolean {
            ...
            subFlow(IdentitySyncFlow.Send(setOf(otherSideSession), tx, Companion.SYNCING_WRAPPER.childProgressTracker()))
            return otherSideSession.receive<Boolean>().unwrap { it }
        }
    }

    @InitiatedBy(IdentitySyncFlowWrapper.Initiator::class)
