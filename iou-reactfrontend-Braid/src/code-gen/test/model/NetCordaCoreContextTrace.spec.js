...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.NetCordaCoreContextTrace();
  });
  ...
  describe('NetCordaCoreContextTrace', function() {
    it('should create an instance of NetCordaCoreContextTrace', function() {
      // uncomment below and update the code to test NetCordaCoreContextTrace
      //var instane = new OpenapiJsClient.NetCordaCoreContextTrace();
      //expect(instance).to.be.a(OpenapiJsClient.NetCordaCoreContextTrace);
    });
