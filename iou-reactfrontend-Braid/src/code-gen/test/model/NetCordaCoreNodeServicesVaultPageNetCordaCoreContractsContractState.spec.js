...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.NetCordaCoreNodeServicesVaultPageNetCordaCoreContractsContractState();
  });
  ...
  describe('NetCordaCoreNodeServicesVaultPageNetCordaCoreContractsContractState', function() {
    it('should create an instance of NetCordaCoreNodeServicesVaultPageNetCordaCoreContractsContractState', function() {
      // uncomment below and update the code to test NetCordaCoreNodeServicesVaultPageNetCordaCoreContractsContractState
      //var instane = new OpenapiJsClient.NetCordaCoreNodeServicesVaultPageNetCordaCoreContractsContractState();
      //expect(instance).to.be.a(OpenapiJsClient.NetCordaCoreNodeServicesVaultPageNetCordaCoreContractsContractState);
    });
